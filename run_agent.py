...
class AIAgent(
    ...
    # NOL-106: de-collide provider-minted tool_call ids at ingestion (see turn_response_intake).
    _namespace_tool_call_ids = _forward_static("agent.agent_runtime_helpers", "namespace_provider_tool_call_ids")
