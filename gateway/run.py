...
_PROVIDER_ERROR_REPLIES = (
    ...
    # Malformed-payload 400: our side, not a provider outage. The pre-call sanitizer strips the
    # offending message, so a resend should succeed (NOL-216/NOL-106).
    (_GATEWAY_VALIDATION_ERROR_RE, "⚠️ I hit an internal error building the request to the model (a "
