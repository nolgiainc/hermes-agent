...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Run-scoped Nolgia platform tokens retained per session (NOL-413).
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if _platform_asset_resolver_enabled():
            ...
            if _retained_token:
                ...
                _nolgia_token_reset = set_session_nolgia_token(_retained_token)
            try:
    ...
    def _bind_api_server_session(
        *,
        ...
        exactly as before. Deployments where workspaces do not apply bind
        exactly as before — no scratch dir, no runtime-cwd bind:
