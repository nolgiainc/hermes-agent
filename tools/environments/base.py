...
# Snapshot-exclusion contract surface (NOL-207 NOLGIA_TOKEN / NOL-414 scoped TMPDIR):
# the gateway-side isolation tests read these through ``tools.environments.base``.
from tools.environments.base_session_env import (  # noqa: F401
    _SNAPSHOT_EXCLUDED_ENV_REGEX, _export_dump_excluding_session_vars, _session_scoped_tmpdir_active,
    snapshot_excluded_env_regex,
)
