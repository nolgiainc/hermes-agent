...
_ROUTING_FIELDS = (
    ...
    # Profile that owns this session — the wake self-post must re-enter
    # through its /p/<profile>/ route (NOL-413). Rides pending_watchers as
    # "profile" via the removeprefix() below.
    ("watcher_profile", "HERMES_SESSION_PROFILE"),
