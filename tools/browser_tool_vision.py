...
def _analyze_screenshot_with_aux_llm(screenshot_path: Path, question: str) -> str:
    ...
    # Timeout resolves through the shared vision budget (config /
    # HERMES_VISION_TIMEOUT, fork default 60s) so a stalled screenshot analysis
    # cannot burn minutes; temperature still reads auxiliary.vision.temperature.
