...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "gemini": [
        "gemini-3.1-pro-preview", "gemini-3-pro-preview", "gemini-3.8-flash", "gemini-3.6-flash",
    ...
    # gemini-3.8-flash was added 2026-09-04 from Google's GA launch docs and has not been re-validated
    # live on Vertex (the rest of this list was, see the comment above).
    "vertex": [
        "google/gemini-3.1-pro-preview", "google/gemini-3-pro-preview", "google/gemini-3.8-flash", "google/gemini-3.6-flash",
