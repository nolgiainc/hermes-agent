...
sidebar_label: "Competitor Social Analysis"
...
Use when analyzing competitor social profiles: collect posts, score performance, break down creative style, propose Nolgia content ideas.
...
| Path | `skills/social-media/competitor-social-analysis` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos |
| Tags | `competitor-analysis`, `social-media`, `content-strategy`, `video-breakdown`, `nolgia` |
| Related skills | [`xurl`](/docs/user-guide/skills/bundled/social-media/social-media-xurl), [`youtube-content`](/docs/user-guide/skills/bundled/media/media-youtube-content) |
